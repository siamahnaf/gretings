...
# A Greeting website using sharefox API
This is a demo website which one I build for my client as interview purposed. Good news is I successfully passed the interview and get the full project work my the we do greetings.
